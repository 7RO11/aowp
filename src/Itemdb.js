const db = {
  ...
  Shotgun: {
    ...
    "Krutt Assault 219 Waltzing Queen Special": {
      ...
      blurb: "Blitzable and part of common loot pools. Notorious crit shotgun.",
      stats: {
    ...
    "Medium Shotgun": {
      ...
      type: "Shotgun",
      blurb:
        "Blitzable, shop buyable and part of common loot pools. Slow, accessible shotgun with decent crits.",
      stats: {
        ql: { value: "1-200", quality: "" },
        dual: { value: "No", quality: "" },
        aSpeed: { value: "2.5s", quality: "r" },
        ...
        specials: { value: "Fling Shot", quality: "" },
        reqs: {
          Shotgun: { value: "904", quality: "" },
          "Fling shot": { value: "453", quality: "" },
        },
        mods: {},
      },
      profs: ["Trader"],
      prk: false,
      diff: 1,
      auno: "https://auno.org/ao/db.php?id=123056",
    },
    Mudurlugu: {
      versions: [
        {
